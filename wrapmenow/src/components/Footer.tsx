...
import { Phone, MapPin, Clock, Mail, WhatsAppIcon, TelegramIcon, VkIcon, InstagramIcon, YouTubeIcon } from "@/components/ui/Icons";
...
const socials = [
  ...
  { icon: YouTubeIcon, label: "YouTube", href: contacts.youtubeUrl },
];
  ...
  return (
    <footer className="bg-deep text-foreground">
      <Container className="py-10 lg:py-12">
        <div className="flex flex-col gap-8 sm:flex-row sm:justify-between">
          <div className="max-w-xs">
            ...
            <p className="mt-2 text-sm leading-relaxed text-foreground/70">
              Студия оклейки и защиты автомобилей — {studio.city}. С {studio.yearFounded} года.
            </p>
        ...
        <div className="mt-8 flex flex-col gap-1.5 border-t border-foreground/15 pt-5 text-xs text-foreground/55">
          <p>
            {studio.fullName} · {contacts.addressFull}
          </p>
          <p>
            {contacts.legal.entity} · ИНН {contacts.legal.inn} · ОГРНИП {contacts.legal.ogrnip}
          </p>
        </div>
      </Container>
    </footer>
