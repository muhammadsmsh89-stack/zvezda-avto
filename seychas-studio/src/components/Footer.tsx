  ...
  return (
    <footer className="bg-deep text-background">
      <Container className="py-10 lg:py-12">
        <div className="flex flex-col gap-8 sm:flex-row sm:justify-between">
          <div className="max-w-xs">
            ...
            <p className="mt-2 text-sm leading-relaxed text-background/70">
              Студия красоты в Туле — ногти · брови · ресницы
            </p>
        ...
        <div className="mt-8 border-t border-background/15 pt-5 text-xs text-background/60">
          Концепт цифрового представительства {studio.name}.
        </div>
      </Container>
    </footer>
  );
