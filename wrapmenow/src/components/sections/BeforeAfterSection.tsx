      ...
      <Container>
        ...
        <Reveal delay={0.06}>
          <h2 className="mt-4 max-w-xl text-pretty text-display font-medium text-foreground">
            Разницу видно до того, как её объяснят
          </h2>
        </Reveal>
        ...
        <Reveal delay={0.12} className="mt-10">
          <div className="relative aspect-[16/10] w-full select-none overflow-hidden rounded-[1.75rem] border border-border sm:aspect-[16/8]">
            <PhotoPanel variant="after" label="Автомобиль после оклейки WrapMeNow" className="absolute inset-0 h-full w-full" showMark={false} />
            <div className="absolute inset-0 overflow-hidden" style={{ clipPath: `inset(0 ${100 - pos}% 0 0)` }}>
              <PhotoPanel variant="before" label="Автомобиль до оклейки" className="h-full w-full" sweepFrom="right" showMark={false} />
            </div>

            <div aria-hidden className="pointer-events-none absolute inset-y-0 w-px bg-background/70" style={{ left: `${pos}%` }} />
          ...
          <p className="mt-4 max-w-xl text-sm text-muted">
            Двигайте ползунок, чтобы сравнить состояние кузова до и после оклейки. Настоящую пару фото «до/после» с одного
            автомобиля студия готовит для следующего обновления сайта — сейчас здесь рабочий макет слайдера.
          </p>
        </Reveal>
      </Container>
    </section>
