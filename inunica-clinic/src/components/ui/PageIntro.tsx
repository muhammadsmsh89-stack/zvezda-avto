...
export function PageIntro({
  ...
  /** Промежуточный уровень крошек, например «Процедуры» для страницы направления. */
  ...
  return (
    <section className="pt-28 pb-14 sm:pt-32 sm:pb-20 lg:pt-40">
      <Container wide>
        ...
        <h1 className="font-display mt-8 max-w-[18ch] text-[2.5rem] text-ink sm:text-[3.5rem] lg:text-[4.5rem]">
          {title}
        </h1>
