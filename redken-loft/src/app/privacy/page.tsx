    ...
    <>
      ...
      <section className="bg-background pb-20 lg:pb-28">
        <Container className="max-w-2xl space-y-6 text-base leading-relaxed text-muted">
          <p>
            Оператором данных, обрабатываемых на этом сайте, является студия {studio.name} ({contacts.addressFull}).
          </p>
          <p>
            Сайт не содержит форм сбора персональных данных. Запись на услуги происходит через мессенджеры
            WhatsApp и Viber либо по телефону — обработка данных в этих случаях регулируется политиками
            соответствующих сервисов.
          </p>
          <p>
            Переходя по ссылкам на WhatsApp, Instagram, VK, Яндекс Карты или 2ГИС, вы покидаете сайт студии и
