...
export const metadata: Metadata = {
  title: "Отзывы",
  description: "Отзывы клиентов Redken Loft: рейтинг 5,0, 209 отзывов на Яндекс Картах, 4,9 на 2ГИС.",
};
  ...
  return (
    <>
      <PageIntro
        ...
        description={`${rating.yandex.value} · ${rating.yandex.reviewsCount} отзывов на ${rating.yandex.source} · ${rating.twoGis.value} на ${rating.twoGis.source}.`}
        action={
          <div className="flex items-center gap-3">
            ...
            <TextLink href={contacts.yandexUrl}>Читать все отзывы на Яндекс Картах</TextLink>
          </div>
        }
      />
        ...
        <Container>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-4">
            {reviewCategories.map((cat, i) => (
              <Reveal key={cat.label} delay={i * 0.06} className="rounded-2xl border border-border bg-background p-6">
