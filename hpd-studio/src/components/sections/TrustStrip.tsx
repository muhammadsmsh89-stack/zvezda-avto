  ...
  return (
    <section className="border-y border-border bg-surface">
      <Container className="flex flex-col items-center gap-6 py-10 sm:flex-row sm:justify-between lg:py-12">
        <Reveal className="flex flex-wrap items-center justify-center gap-8 sm:gap-10">
          {stats.map((s) => (
          ...
          <div className="flex items-center gap-1.5 rounded-full border border-border-strong px-4 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-foreground">
            {rating.award}
          </div>
        </Reveal>
