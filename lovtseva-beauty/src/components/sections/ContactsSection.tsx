...
import { MapPin, Clock, Phone, WhatsAppIcon, Mail } from "@/components/ui/Icons";
    ...
    <section id="contacts" className={clsx("bg-background pb-20 lg:pb-28", className ?? "pt-20 lg:pt-28")}>
      <Container className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div>
          ...
          <Reveal delay={0.08}>
            <h2 className="mt-4 text-pretty font-serif text-3xl leading-[1.1] text-foreground sm:text-4xl">Ждём вас в центре</h2>
          </Reveal>
          ...
          <Reveal delay={0.3} className="mt-9 flex flex-wrap items-center gap-5">
            ...
            <TextLink href={contacts.telegramUrl}>Написать в Telegram</TextLink>
          </Reveal>
        </div>
        ...
        <Reveal delay={0.15}>
          ...
          >
            <PhotoPlaceholder
              shotNumber="MAP"
              label="Быстрецкая ул., 20"
              description="Вход в центр красоты Натальи Ловцевой на Быстрецкой, 20"
              tone="ivory"
              subject="wide"
