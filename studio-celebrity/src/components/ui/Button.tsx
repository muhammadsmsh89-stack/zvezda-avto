...
const base =
  "inline-flex items-center justify-center gap-2.5 rounded-full font-semibold transition-all duration-300 active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-4 whitespace-nowrap";
...
const variants: Record<Variant, string> = {
  ...
  nude: "bg-nude text-foreground hover:bg-nude-strong",
};
